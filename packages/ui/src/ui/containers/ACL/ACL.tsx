...
class ACL extends Component<Props> {
    ...
    getObjectPermissionsDetaila() {
        ...
        const {data, title, noItemsText, extraColumns} = {
            [AclMode.MAIN_PERMISSIONS]: {
                ...
                noItemsText: 'There are no any column permissions',
            ...
            [AclMode.COLUMN_GROUPS_PERMISSIONS]: {
                ...
                noItemsText: 'There are no any object permissions',
                extraColumns: ['columns'] as const,
            },
            [AclMode.ROW_GROUPS_PERMISSIONS]: {
                data: rowPermissions,
                title: 'Private row permissions',
                noItemsText: 'There are no any row permissions',
    ...
    renderObjectPermissions() {
        ...
        const {
            ...
            noItemsText,
        } = this.getObjectPermissionsDetaila();
